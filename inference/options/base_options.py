...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--max_dataset_size', type=int, default=20, help='Maximum number of samples allowed per dataset. If the dataset directory contains more than max_dataset_size, only a subset is loaded.')
